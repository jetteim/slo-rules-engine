...
1. generate reviewed draft definitions from accepted handoff packets without rerunning backend discovery
2. validate accepted handoff packets before provider handoff
